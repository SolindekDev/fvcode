...
/* Use FV_TRY */
i32 FV_AppendComponent(fv_component_manager_t* manager, fv_component_t* component);

/* Use FV_TRY */
i32 FV_DeleteComponentByName(fv_component_manager_t* manager, const char* component_name);
/* Use FV_TRY */
i32 FV_DeleteComponentByID  (fv_component_manager_t* manager, i32 component_id);
